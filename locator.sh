#!/bin/bash
# IPLocator v1.0
# Coded by: imshown (You dont become a coder by just changing the credits)
# Github: https://github.com/funtechhack/iplocate.git
...
printf "\e[1;77m     ||    ||_____|| | |      / _ \  / ___)(____ |(_   _)/ _ \  / ___) \e[0m\n"
printf "\e[1;77m     ||    ||        | |_____| |_| |( (___ / ___ |  | |_| |_| || |     \e[0m\n"
printf "\e[1;77m  ======== ||        |_______)\___/  \____)\_____|   \__)\___/ |_|    v1.1 \e[0m\n"
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: @imshown\e[0m\n"
